...
private:
	...
	static int			m_nJoyTimer[MAX_DIRECTION];
...
public:
	...
	static float GetStick(float);
	static bool GetStickLTrigger(DWORD dwjoy, STICKDIRECTION, int time);
