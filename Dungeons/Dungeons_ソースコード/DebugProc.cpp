...
// ===マクロ定義===
#define	TEXTURE_FILENAME	"data/texture/PressStart2Ph_e.png"
#define FONT_WIDTH			16
#define FONT_HEIGHT			16

// ===静的メンバ===
Texture* CDebugProc::m_pTexture;					// テクスチャへのポインタ
...
HRESULT CDebugProc::Init()
{
	...
	// テクスチャの読み込み
	m_pTexture = TextureFactory::CreateFromFile(TEXTURE_FILENAME);
...
void CDebugProc::Draw()
{
	...
	CPolygon::SetTexture(m_pTexture->GetResource());
